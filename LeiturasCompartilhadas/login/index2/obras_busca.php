...
<html lang="pt">
  ...
  <body>
    ...
    <!-- END section -->
      ...
      <form  action="obras_busca.php" method="post">
      
              <div class="form-group">
              <input class="form-control" placeholder="Busque por obras" style="width:450px;margin-left:52px;margin-top:15px" type="text" name="pesquisa"/> 
              </div>
          </form>
