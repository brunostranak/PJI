  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand absolute" href="index.html">Sobre nós<span class="fa fa-heart text-primary"></span>  </a>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 order-md-2">
            <div class="block-16">
              <figure>
                <img style="width: 300px;" src="images/me.jpg" alt="Image placeholder" class="img-fluid img-shadow">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="block-43">
              ...
              <div class="block-43-text">
                <h3 class="block-43-heading">Desenvolvedores</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="block-43">
              ...
              <div class="block-43-text">
                <h3 class="block-43-heading">Clube de leitura</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A quibusdam nisi eos accusantium eligendi velit deleniti nihil ad deserunt rerum.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="block-43">
              ...
              <div class="block-43-text">
                <h3 class="block-43-heading">"Literature-se"</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A quibusdam nisi eos accusantium eligendi velit deleniti nihil ad deserunt rerum.</p>
              </div>
            </div>
          </div>
